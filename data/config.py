...
SUNRGBD_CLASSES = ('wall', 'cabinet', 'bed', 'chair', 'sofa', 'table', 'door', 'window', 'bookshelf', 'picture', 'counter', 'blinds', 'desk', 'shelves', 'curtain', 'dresser', 'pillow', 'mirror', 'floor_mat', 'clothes', 'ceiling', 'books', 'tv', 'paper', 'towel', 'shower_curtain', 'box', 'whiteboard', 'person', 'night_stand', 'toilet', 'sink', 'lamp', 'bathtub', 'bag', 'laptop', 'monitor', 'computer', 'keyboard', 'mouse', 'bottle', 'cup', 'phone', 'doorhandle', 'potted plant', 'bowl', 'umbrella')

SUNRGBD_CLASSES2 = ('wall', 'chair', 'sofa', 'desk', 'door', 'window', 'books', 'box', 'person', 'bag', 'laptop', 'monitor', 'computer', 'keyboard', 'mouse', 'bottle', 'cup', 'cell phone', 'bowl')

my_custom_dataset = dataset_base.copy({
    'name': 'My Dataset',

    'train_images': '../../../data/yolact_custom_data/SUNRGBD_image/',
    'train_info': './data/SUNRGBD_annotation/annotation_merged.json',
    
    'valid_images': '../../../data/yolact_custom_data/SUNRGBD_image/',
    'valid_info': './data/SUNRGBD_annotation/annotation_merged.json',
    
    'has_gt': True,
    
    'class_names': SUNRGBD_CLASSES,

})

my_custom_dataset2 = dataset_base.copy({
    'name': 'My Dataset2',

    'train_images': '../../../data/yolact_custom_data/coco2/',
    'train_info': './data/SUNRGBD_annotation/annotation_coco_merged.json',
    
    'valid_images': '../../../data/yolact_custom_data/coco2/',
    'valid_info': './data/SUNRGBD_annotation/annotation_coco_merged.json',
...
my_custom_dataset3 = dataset_base.copy({
    'name': 'My Dataset3',

    'train_images': '../../../data/yolact_custom_data/SUNRGBD_image2/',
    'train_info': './data/SUNRGBD_annotation/annotation_SUNRGBD_only.json',
    
    'valid_images': '../../../data/yolact_custom_data/SUNRGBD_image2/',
    'valid_info': './data/SUNRGBD_annotation/annotation_SUNRGBD_only.json',
    
    'has_gt': True,
    
    'class_names': SUNRGBD_CLASSES2,

})

IMMERSIVE_MR_CLASSES = ('person', 'bag', 'umbrella', 'bottle', 'cup', 'chair', 'sofa', 'potted plant', 'desk', 'monitor', 'laptop', 'mouse', 'remote', 'keyboard', 'cell phone', 'book', 'clock', 'door')

immersiveMR_dataset = dataset_base.copy({
    'name' : 'immersiveMR',
    
    'train_images' : '../../../data/immersiveMR_data/coco_door_mix_train/',
    'train_info' : './data/SUNRGBD_annotation/final2_annotation_train.json',
    
    'valid_images' : '../../../data/immersiveMR_data/coco_door_mix_val/',
    'valid_info' : './data/SUNRGBD_annotation/final2_annotation_val.json',
    
    'has_gt' : True,
    
    'class_names' : IMMERSIVE_MR_CLASSES
    
})

PILOT_STUDY_CLASSES = ('person','bottle', 'cup', 'laptop',  'cell phone', 'book')

pilotstudy_dataset = dataset_base.copy({
    'name' : 'PilotStudy',
    'train_images' : '../../../data/immersiveMR_data/coco_door_mix_train/',
    'train_info' : './data/SUNRGBD_annotation/ann1008_train.json', 
    
    'valid_images' : '../../../data/immersiveMR_data/coco_door_mix_val/',
    'valid_info' : './data/SUNRGBD_annotation/ann1008_val.json',
    
    'has_gt' : True,
    
    'class_names' : PILOT_STUDY_CLASSES
})
...
yolact_base_config = coco_base_config.copy({
    ...
    #[(None) ~] : upsample + conv >> 이거 추가하면 high resolution 얻을 수 있을거라고 함
...
yolact_plus_SUNRGBD_config = yolact_plus_resnet50_config.copy({
    'name' : 'yolact_plus_SUNRGBD',
    'dataset' : my_custom_dataset,
    'num_classes' : len(SUNRGBD_CLASSES) + 1
  
})

yolact_plus_SUNRGBD_config2 = yolact_plus_resnet50_config.copy({
    'name' : 'yolact_plus_SUNRGBD2',
    'dataset' : my_custom_dataset2,
    'num_classes' : len(SUNRGBD_CLASSES) + 1
  
})

yolact_plus_SUNRGBD_config3 = yolact_plus_resnet50_config.copy({
    'name' : 'yolact_plus_SUNRGBD3',
    'dataset' : my_custom_dataset3,
    'num_classes' : len(SUNRGBD_CLASSES2) + 1

})

yolact_plus_IMMERSIVEMR_config = yolact_plus_resnet50_config.copy({
    'name' : 'yolact_plus_immersiveMR',
    'dataset' : immersiveMR_dataset,
    'num_classes' : len(IMMERSIVE_MR_CLASSES) + 1,
    
   'max_size' : 600,
   'lr': 1e-5,
    
    'lr_steps': (140000, 300000, 350000, 375000),
    'max_iter': 400000,
})

yolact_plus_PILOTSTUDY_config = yolact_plus_resnet50_config.copy({
    'name' : 'yolact_plus_PilotStudy',
    'dataset' : pilotstudy_dataset,
    'num_classes' : len(PILOT_STUDY_CLASSES) + 1,
    
    'max_size' : 600,
    'lr' : 1e-6,
    'lr_steps' : (210000, 450000, 525000, 562500),
    'max_iter' : 600000
})
