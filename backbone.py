...
#위의 bottleneck class를 사용해서 Implement
class ResNetBackbone(nn.Module):
    ...
    def __init__(self, layers, dcn_layers=[0, 0, 0, 0], dcn_interval=1, atrous_layers=[], block=Bottleneck, norm_layer=nn.BatchNorm2d):
        ...
        # conv2's stride is 2, it reduces input size by 2
        # max pooling reduces input sized by 2, finally stage 1 shricks size by 4
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dcn_layers=0, dcn_interval=1):
        ...
        # All stages (except stage 1) has conv block, 
        # and it reduces image size by half. (stage 2 has conv block wich is stirde 1)
